function calcShipping(sum, min, shipping) {
    ...
    if (productsSum == 0) {
        shippingSum = 0; // доставка бесплатна, если сумма заказа больше или равна минимальной для бесплатной доставки или корзина пуста
    }  
...
function calcInvoice({sum, discountMinSum, discountPart, shippingFreeMinSum, shippingPrice}) {
    ...
    switch(shippingSum) {
        case 0 : freeShipping =  true; break 
